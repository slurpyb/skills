...
This gate is the skill’s **quality estimator**: pass → integrate; fail → one tighter packet, cascade once to a stronger _installed_ model, or finish solo — never silent accept.
