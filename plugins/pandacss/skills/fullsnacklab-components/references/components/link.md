...
Navigate to another location with design-system styling.

## Import

```tsx
import { Link } from "@fullsnacklab/components";
```
...
- Components and helpers: `Link`.
- Exported contract types: `LinkProps`.
