...
Present an inline status, warning, success, or error message.

## Import

```tsx
import { Alert } from "@fullsnacklab/components";
```
...
- Components and helpers: `Root`, `Title`, `Description`, `Content`, `Indicator`.
