...
Attach contextual text or actions beside an input.

## Import

```tsx
import { InputAddon } from "@fullsnacklab/components";
```
...
- Components and helpers: `InputAddon`.
- Exported contract types: `InputAddonProps`.
...
- An addon is contextual presentation, not a substitute for a field label.
