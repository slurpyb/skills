...
- Only use a named MCP/tool if it is present in this session. If Context7, fetch, or similar are missing, skip them and use available tools. Never invent results from a tool that did not run.
```
