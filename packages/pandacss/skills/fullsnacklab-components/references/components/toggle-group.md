...
Select one or more compact toggle actions from a set.

## Import

```tsx
import { ToggleGroup } from "@fullsnacklab/components";
```
...
- Components and helpers: `Root`, `RootProvider`, `Item`, `Context`.
