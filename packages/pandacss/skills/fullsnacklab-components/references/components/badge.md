...
Attach a compact status or category label to nearby content.

## Import

```tsx
import { Badge } from "@fullsnacklab/components";
```
...
- Components and helpers: `Badge`.
- Exported contract types: `BadgeProps`.
