...
Render a value with the package's display treatment.

## Import

```tsx
import { DisplayValue } from "@fullsnacklab/components";
```
...
- Components and helpers: `DisplayValue`.
- Exported contract types: `DisplayValueProps`.
