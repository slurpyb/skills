...
[astro-islands-and-extraction](astro-islands-and-extraction.md).
...
- Utilities across `.astro` + React/Vue/Svelte/Solid islands, and the extraction model →
  [astro-islands-and-extraction](astro-islands-and-extraction.md)
- Markdown/MDX, content collections, and prose → [astro-content-and-prose](astro-content-and-prose.md)
